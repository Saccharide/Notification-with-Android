...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendNotification(){
        ...
        NotificationChannel channel = new NotificationChannel(id, "Notification Project", NotificationManager.IMPORTANCE_DEFAULT);
        ...
        builder.setContentText("By: Saccharide");
